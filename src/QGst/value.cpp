...
void registerValueVTables()
{
    struct ValueVTable_MiniObject
    {
        ...
        {
            *reinterpret_cast<GstMiniObject**>(data) = reinterpret_cast<GstMiniObject *>(g_value_get_boxed(value));
        };
    ...
    struct ValueVTable_Fourcc
    {
        static void get(const QGlib::Value & value, void *data)
        {
            reinterpret_cast<Fourcc*>(data)->value.as_integer = GPOINTER_TO_INT(g_value_get_boxed(value));
        };

        static void set(QGlib::Value & value, const void *data)
        {
            g_value_set_boxed(value, GINT_TO_POINTER(reinterpret_cast<Fourcc const *>(data)->value.as_integer));
        };
    };
    ...
    struct ValueVTable_QDate
    {
        static void get(const QGlib::Value & value, void *data)
        {
            const GDate *gdate = reinterpret_cast<const GDate *>(g_value_get_boxed(value));
